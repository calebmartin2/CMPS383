...
namespace SP22.P03.Web.Migrations
{
    ...
    [Migration("20220312174224_changing-isactive-to-status")]
    partial class changingisactivetostatus
    {
            ...
            modelBuilder.Entity("SP22.P05.Web.Features.Authorization.ProductUserInfo", b =>
                {
                    ...
                    b.HasOne("SP22.P05.Web.Features.Authorization.UserInfo", "UserInfos")
                        .WithMany("Products")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SP22.P05.Web.Features.Products.ProductTag", b =>
                {
                    ...
                    b.HasOne("SP22.P05.Web.Features.Products.Tag", "Tag")
                        .WithMany("Products")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
